...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            if (storedUserId) {
                const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find({
                    "AuthProvider.useEffect.foundUser": (u)=>u.id === Number.parseInt(storedUserId)
    ...
    const login = (userId)=>{
        const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === userId);
        if (foundUser) {
            setUser(foundUser);
...
//# sourceMappingURL=_c74c3bd9._.js.map